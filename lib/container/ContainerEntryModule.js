...
class ContainerEntryModule extends Module {
	...
	build(options, compilation, resolver, fs, callback) {
		...
		// 这里就是根据 exposes 的配置创建 block 和 block 之间的关系、依赖关系的过程
		for (const [name, options] of this._exposes) {
			// TODO 理解 DependenciesBlock 的概念，AsyncDependenciesBlock 的区别又是什么
		...
		// 需要了解在将 Dependency -> module 过程中，StaticExportsDependency 与其它 Dependency 的区别
